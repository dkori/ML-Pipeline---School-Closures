...
#save model
save(base_model,file="trained neural net.RData")
...
freeze_weights(base_model,from=1,to=4)
unfreeze_weights(base_model,from=5)
ft%>%compile(optimizer=optimizer_sgd(lr=0.0001,momentum-0.9),
             loss='binary_crossentropy')
history2<-ft%>%fit(x=xtrain,y=ytrain,epochs2,batch_size=8)
