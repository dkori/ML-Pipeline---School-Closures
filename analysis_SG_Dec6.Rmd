...
glm_base_p<-predict(glm.fits_closed, validation,type="response")

validation$closed_any
```
...
glm_os_p<-predict(glm.fits_closedOS, validation, type="response")
...
# Make predictions
predicted.classes <- fda.Fit %>% predict(validation,type=)

#save predictions from all models

save(glm_base_p,glm_os_p,validation,file="glm.Rdata")
# Model accuracy
